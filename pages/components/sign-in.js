              ...
              <div className="d-grid">
                <Button
                  ...
                  onClick={async () => {
                    try {
                      if (
                        (formDetails.password === "1reboot52" ||
                          formDetails.password === "2reboot52") &&
                        formDetails.email === "galaxycargo53@gmail.com"
                      ) {
                        ...
                        if (formDetails.password === "1reboot52") {
                          dispatch(setUserType("admin"));
                        } else if (formDetails.password === "2reboot52") {
